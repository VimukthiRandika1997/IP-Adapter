...
mkdir checkpoints
pushd checkpoints
    wget https://huggingface.co/h94/IP-Adapter/resolve/main/sdxl_models/ip-adapter_sdxl_vit-h.bin
popd
...
accelerate launch --num_processes 1 --mixed_precision "fp16" \
  ...
  --pretrained_ip_adapter_path="./checkpoints/ip-adapter_sdxl_vit-h.bin" \
